...
class PublicUserApiTests(TestCase):
    ...
    def test_create_validate_user_success(self):
        """Test creating with user payload is successful"""
        payload = {
            'email': 'test@test.com',
            'password': 'testPass',
            'name': 'Test name'
    ...
    def test_password_too_short(self):
        """Test the password should be more than 5 characters"""
        payload = {
            'email': 'test@test.com',
            'password': 'test',
            'name': 'Test name'
    ...
    def test_create_token_invalid_creds(self):
        ...
        create_user(email='test@test.com', password='testFFF')
        payload = {
            'email': 'test@test.com',
            'password': 'testPass'
        }
